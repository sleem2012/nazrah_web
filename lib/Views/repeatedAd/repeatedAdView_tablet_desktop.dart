...
class RepeatedAdViewTabletDesktop extends StatefulWidget {
  @override
  _RepeatedAdViewTabletDesktopState createState() =>
      _RepeatedAdViewTabletDesktopState();
}

class _RepeatedAdViewTabletDesktopState
    extends State<RepeatedAdViewTabletDesktop> {
  @override
  void initState() {
    super.initState();
