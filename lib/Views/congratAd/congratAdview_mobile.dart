...
class CongratAdViewMobile extends StatefulWidget {
  @override
  _CongratAdViewMobileState createState() => _CongratAdViewMobileState();
}

class _CongratAdViewMobileState extends State<CongratAdViewMobile> {
  @override
  void initState() {
    super.initState();
