...
class LegacyViewMobile extends StatefulWidget {
  @override
  _LegacyViewMobileState createState() => _LegacyViewMobileState();
}

class _LegacyViewMobileState extends State<LegacyViewMobile> {
  @override
  void initState() {
    super.initState();
  }
