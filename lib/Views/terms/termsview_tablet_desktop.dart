...
class TermsViewTabletDesktop extends StatefulWidget {
  @override
  _TermsViewTabletDesktopState createState() => _TermsViewTabletDesktopState();
}

class _TermsViewTabletDesktopState extends State<TermsViewTabletDesktop> {
